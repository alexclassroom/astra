 ...
 * @since x.x.x
 */
function astra_get_advanced_spacing_css( $section_id, $selector ) {
...
/**
 * Get Advanced Border-spacing Dynamic CSS for sub sections.
 *
 * @param string $section_id section id.
 * @param string $selector selector.
 * @return string
 ...
 * @since x.x.x
 */
function astra_get_sub_section_dynamic_css( $section_id, $selector ) {
	...
	if ( ! empty( $section_id ) && ! empty( $selector ) ) {
		...
		$css_output .= astra_get_advanced_spacing_css( $section_id, $selector );
