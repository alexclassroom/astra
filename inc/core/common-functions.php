 ...
 * @return void
 */
function astra_theme_get_template( $template_name, $args = array(), $template_path = '', $default_path = '' ) {

	$located = astra_theme_locate_template( $template_name, $template_path, $default_path );
 ...
 */
function astra_theme_locate_template( $template_name, $template_path = '', $default_path = '' ) {
	...
	if ( ! $default_path ) {
		$default_path = ASTRA_THEME_DIR . 'inc/';
	}
